...
class Note extends FlxSprite
{
	...
	public var inEditor:Bool = Type.getClassName(Type.getClass(FlxG.state)) == 'funkin.editors.ChartingState';
	...
	private function reloadNote(?texture:String = '', ?postfix:String = '') {
		...
		if(inEditor) {
			setGraphicSize(funkin.editors.ChartingState.GRID_SIZE, funkin.editors.ChartingState.GRID_SIZE);
			updateHitbox();
		}
	}
