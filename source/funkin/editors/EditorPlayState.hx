...
import funkin.Character.CharacterFile;
...
class EditorPlayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		grpOptionsNoteSplashes = new FlxTypedGroup<NoteSplash>();
	...
	private function endSong() {
		...
		LoadingState.loadAndSwitchState(funkin.editors.ChartingState.new);
	}
